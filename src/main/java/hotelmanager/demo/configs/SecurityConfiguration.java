...
//
                        ...
                        .requestMatchers(HttpMethod.GET, "admin/bookings/getall").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.RECEPTIONIST.name(), RoleType.SERVICE_MANAGER.name(), RoleType.SERVICE_COUNTER.name(), RoleType.BAR_COUNTER.name(), RoleType.RESTAURANT_COUNTER.name())
                        .requestMatchers(HttpMethod.GET, "admin/bookings/{id}").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.RECEPTIONIST.name(), RoleType.SERVICE_MANAGER.name(), RoleType.SERVICE_COUNTER.name(), RoleType.BAR_COUNTER.name(), RoleType.RESTAURANT_COUNTER.name())
                        .requestMatchers(HttpMethod.GET, "admin/bookings/search-cusname").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.RECEPTIONIST.name(), RoleType.SERVICE_MANAGER.name(), RoleType.SERVICE_COUNTER.name(), RoleType.BAR_COUNTER.name(), RoleType.RESTAURANT_COUNTER.name())
                        .requestMatchers(HttpMethod.GET, "admin/bookings/search").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.RECEPTIONIST.name(), RoleType.SERVICE_MANAGER.name(), RoleType.SERVICE_COUNTER.name(), RoleType.BAR_COUNTER.name(), RoleType.RESTAURANT_COUNTER.name())
